function createRestaurantMenuPage() {
    ...
    menuDesc2.textContent = "The Assassin's Spaghetti is a spin on the signature classic. Pan cooked spaghetti with a texture different to that of normal spaghetti with added chili peppers to give an extra kick.";
    ...
    menuDesc7.textContent = 'Browned chicken breasts, with cooked wine and butter served on top as sauce.';
